...
- 安全快门速度：最慢的快门速度应该是你使用的焦距的倒数
- 追随拍摄时使用快门优先，快门速度最快尽量不要超过1/60秒，最慢不要超过1/4秒，对好焦之后，最好切换成手动对焦模式，就不怕相机再自己对焦失了原本对好的焦点了。准备拍之前要一直跟着主体移动，在拍的位置按下快门，然后继续保持跟随，直到快门闭合。
...
### 超焦距
- 一个固定的光圈和焦距能达到的最大对焦范围就是超焦距<br>
- 当对焦在A点时，B点是后景深边界，那么对焦在B点是，A点就是前景深边界；用对焦在无穷远上的镜头拍一张，看看最近的清晰的东西是什么（前景深边界在哪），然后对着这里对焦就行了，这就是超焦距
<div align=center>
